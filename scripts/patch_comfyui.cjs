...
const replacements = [
  ...
  })),
  {
    ...
    to: "async function __improvedPhoneLoadPresetResources(e){const n=e&&'object'==typeof e?e:{},t={data:!1,stickers:!1,regex:!1};if(!1!==n.loadData)try{const e=getVariables({type:'character'})||{},n={...r().get(e,'phone_data')||{},user:r5.kQ,characters:r5.hg,randomAvatars:r5.I1,backgrounds:r5.sQ,music:r5.Og,map:r5.Tj,groups:r5.TN,fonts:r5.lG};r().set(e,'phone_data',n),await replaceVariables(e,{type:'character'}),t.data=!0}catch(e){console.error('[Improved Phone] preset data load failed:',e)}if(!1!==n.loadStickers)try{const e=getVariables({type:'character'})||{};r().set(e,'phone_stickers',Yl),await replaceVariables(e,{type:'character'}),t.stickers=!0}catch(e){console.error('[Improved Phone] preset stickers load failed:',e)}if(!1!==n.importRegex)try{await b5(),t.regex=!0}catch(e){console.error('[Improved Phone] preset regex import failed:',e)}return t}globalThis.__improvedPhoneLoadPresetResources=__improvedPhoneLoadPresetResources;async function y5(){",
  },
  {
    name: 'P26_other_settings_preset_action',
    from: "b=(0,i.ref)(!1),{otherSettings:v,saveToStorage:x}=uN();",
    to: "b=(0,i.ref)(!1),P=(0,i.ref)(!1),Q=async()=>{if(P.value||!confirm('将用内置预置覆盖当前角色卡的基础数据、背景、头像、音乐、地图、群组、字体和表情包，并导入默认正则。是否继续？'))return;P.value=!0;try{const e=globalThis.__improvedPhoneLoadPresetResources;if('function'!=typeof e)throw new Error('预置资源加载函数不可用');const n=await e({loadData:!0,loadStickers:!0,importRegex:!0});n.data&&n.stickers&&n.regex?toastr.success('预置资源已载入'):toastr.warning('部分预置资源载入失败，请查看控制台')}catch(e){console.error('[OtherSettings] 载入预置资源失败:',e),toastr.error('载入预置资源失败')}finally{P.value=!1}},{otherSettings:v,saveToStorage:x}=uN();",
  },
  {
    name: 'P27_other_settings_preset_button',
    from: ",(0,i.createCommentVNode)(' 时间设置 '),(0,i.createElementVNode)('div',fO,[",
    to: ",(0,i.createCommentVNode)(' 预置资源 '),(0,i.createElementVNode)('div',fO,[(0,i.createElementVNode)('div',{class:'section-title'},'预置资源',-1),(0,i.createElementVNode)('div',{class:'info-note'},[(0,i.createElementVNode)('i',{class:'fas fa-database'},null,-1),(0,i.createElementVNode)('span',null,'为当前角色卡载入内置背景、头像、表情包等初始资源',-1)]),(0,i.createElementVNode)('button',{type:'button',class:'binding-btn',disabled:P.value,onClick:Q},[(0,i.createElementVNode)('i',{class:'fas fa-download'},null,-1),(0,i.createElementVNode)('span',null,(0,i.toDisplayString)(P.value?'载入中...':'载入预置资源'),1)],8,['disabled'])]),(0,i.createCommentVNode)(' 时间设置 '),(0,i.createElementVNode)('div',fO,[",
  },
];
